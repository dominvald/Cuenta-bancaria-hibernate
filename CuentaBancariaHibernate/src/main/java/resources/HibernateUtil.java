...
public class HibernateUtil {
	/**
	 * La necesitamos para crear la SessionFactory, que hará la conexión con la base
	 * de datos, la declaramos como estática porque una vez creada e iniciada la
	 * utilizaremos para crear nuestras entitymanager, y la mantedremos activa todo
	 * el tiempo, pasándola de un lado a otro pasando la SessionFactory con el
